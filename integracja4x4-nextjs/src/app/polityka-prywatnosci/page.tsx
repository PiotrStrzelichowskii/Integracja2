    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="bg-mud-dark text-sand-light py-16">
        <div className="container mx-auto px-4">
          ...
          <p className="text-center text-sand-light/80 font-roboto-slab max-w-2xl mx-auto">
      ...
      <div className="container mx-auto px-4 py-16 max-w-4xl">
        <Card className="mb-8">
          <CardContent className="pt-6">
            <p className="font-roboto-slab text-muted-foreground leading-relaxed">
            ...
            <p className="font-roboto-slab text-muted-foreground leading-relaxed mt-4">
        ...
        <Card className="mb-8">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="bg-muted/30 p-6 rounded-lg">
              <p className="font-roboto-slab font-semibold text-foreground mb-4">
                PS Bikes Mariusz Strzelichowski
              </p>
              <div className="space-y-2">
                <div className="flex items-start">
                  <MapPin className="w-5 h-5 text-accent mr-3 mt-1 flex-shrink-0" />
                  <div className="font-roboto-slab text-muted-foreground">
                ...
                <div className="flex items-center">
                  ...
                  <span className="font-roboto-slab text-muted-foreground">+48 501 318 521</span>
                </div>
                <div className="flex items-center">
                  <Mail className="w-5 h-5 text-accent mr-3 flex-shrink-0" />
                  <a href="mailto:info@integracja4x4.pl" className="font-roboto-slab text-accent hover:underline">
        ...
        <Card className="mb-8">
          ...
          <CardContent className="space-y-4">
            ...
            <ul className="list-disc list-inside space-y-2 font-roboto-slab text-muted-foreground ml-4">
        ...
        <Card className="mb-8">
          ...
          <CardContent className="space-y-6">
            <div>
              ...
              <p className="font-roboto-slab text-muted-foreground leading-relaxed mb-3">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-4">
              <div className="bg-muted/20 p-4 rounded-lg">
                ...
                <p className="font-roboto-slab text-muted-foreground text-sm leading-relaxed">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="border-l-4 border-accent pl-4">
                ...
                <p className="font-roboto-slab text-muted-foreground text-sm">
            ...
            <div className="bg-accent/10 p-4 rounded-lg mt-6">
              <p className="font-roboto-slab text-foreground font-semibold mb-2">
        ...
        <Card className="mb-8">
          ...
          <CardContent className="space-y-4">
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-1 font-roboto-slab text-muted-foreground ml-4 mt-2">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="bg-muted/30 p-6 rounded-lg">
              <div className="space-y-3">
                <div className="flex items-center">
                  <Mail className="w-5 h-5 text-accent mr-3 flex-shrink-0" />
                  <a href="mailto:info@integracja4x4.pl" className="font-roboto-slab text-accent hover:underline font-semibold">
                    info@integracja4x4.pl
                  </a>
                </div>
                <div className="flex items-center">
        ...
        <div className="text-center mt-12 pt-8 border-t border-border">
          ...
          <p className="font-roboto-slab text-muted-foreground text-sm mt-2">
