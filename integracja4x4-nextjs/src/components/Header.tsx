        ...
        <div className="relative h-full flex flex-col rounded-l-2xl overflow-hidden">
          ...
          <div className="p-6 border-t border-accent/20">
            <div className="flex items-center justify-between">
              ...
              {/* Social Media Icons */}
              <div className="flex items-center space-x-4">
                <a href="https://www.instagram.com/integracja4x4.pl/" target="_blank" rel="noopener noreferrer" className="text-foreground hover:text-accent transition-colors">
                ...
                <a href="https://www.facebook.com/integracja4x4" target="_blank" rel="noopener noreferrer" className="text-foreground hover:text-accent transition-colors">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
